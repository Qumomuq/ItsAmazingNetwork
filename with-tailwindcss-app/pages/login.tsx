                ...
                <div className="flex h-screen flex-col items-center md:flex-row">
                    ...
                    <div className="w-full mt-16 md:mt-0 md:w-2/5">
                        <div
                            ...
                            <p className="w-full mt-4 text-sm text-center text-gray-500">Нет аккаунта?  <Link
                                href="/registration" className="text-blue-500 underline">Зарегистрируйтесь здесь</Link></p>
                        </div>
                    </div>
                </div>
            </div>
